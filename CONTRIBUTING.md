...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   and add the ShoePallete remote:

   ```bash
   # Clone your fork of the repo into the current directory
   git clone https://github.com/<your-username>/ShoePallete.git
   # Navigate to the cloned directory
   cd ShoePallete
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/dvjsharma/ShoePallete.git
   ```
...
2. **Clone the Repository:**
   - If you haven't cloned the ShoePallete repository yet, you can do so by clicking on the "File" menu and selecting "Clone Repository."
   - Choose the ShoePallete repository from the list of repositories on GitHub and clone it to your local machine.
...
7. **Create a Pull Request:**
  - Go to the GitHub website and navigate to your fork of the ShoePallete repository.
...
9. **Wait for Review:**
    Your pull request will now be available for review by the project maintainers. They may provide feedback or ask for changes before merging your pull request into the main branch of the ShoePallete repository.
